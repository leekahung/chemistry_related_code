'''
Title: Molecular Weight Solver (v1.1)
By: Ka Hung Lee
Date: 04/14/2022
Description: Simple Python code to calculate molecular weight of the chemical 
             formula given. This version is modified from the original version 
             to work with partial_pressure_calculator.py for its partial
